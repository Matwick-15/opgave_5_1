...
int main()
{
  ...
  while (1)
  {
    ...
    if (t_flag1)
    {
      ...
      // print af RPS
      RPS_1 = 1 / freq1;
      dtostrf(RPS_1 / 48.0, 0, 2, temp);
      sprintf(RPM1_print, "%s", temp);
      ssd1306_printText(0, 2, RPM1_print);
    }
    if (t_flag2)
    {
      t_flag2 = 0;

      freq2_av = (unsigned int)freq2 / (2 * 48);
      ...
      // print af RPS
      RPS_2 = 1 / freq2;
      dtostrf(RPS_2 / 48.0, 0, 2, temp);
      sprintf(RPM2_print, "%s", temp);
      ssd1306_printText(0, 4, RPM2_print);
    }

    ssd1306_printUI32(0, 1, freq1_av, 0);

    ssd1306_printUI32(0, 3, freq2_av, 0);
  }
}
